...
import { Folder, Scale, BookOpen, Inbox, ScrollText, Landmark, FileText, NotebookPen, User, } from 'lucide-react';


export default function ExpedientePage() {
  const [seccionesActivas, setSeccionesActivas] = useState(["resumen"]);
...
return (
    <div className="min-h-screen bg-gray-50 dark:bg-transparent transition-colors duration-500">
        <section className="container mx-auto px-4 py-16 max-w-6xl">
            ...
            <div className="sticky top-20 z-20 rounded-2xl border border-gray-200 bg-white/80 p-4 mb-8 backdrop-blur dark:border-gray-800 dark:bg-gray-900/80">
                <div className="flex flex-wrap gap-3">
                    ...
                    return (
                        <button
                        key={sec.id}
                        onClick={() => setSeccionesActivas(prev => activa ? prev.filter(s => s !== sec.id) : [...prev, sec.id])}
                        className={`flex items-center gap-2 px-4 py-3 rounded-xl font-medium transition-all ${activa ? "bg-primary text-white" : "bg-gray-100 dark:bg-gray-800"}`}
                        >
                        <Icono size={18} />
                        {sec.titulo}
                        </button>
            ...
            {/* ================= RESUMEN ================= */}
            {seccionesActivas.includes("resumen") && (
                <Card>
                    <IconBox><Folder size={35} /></IconBox>
                        ...
                        <p className="mt-3 text-gray-600 dark:text-gray-400 text-lg">
                            Conoce de forma sencilla el avance de esta propuesta presentada ante el Congreso.
                        </p>
                        ...
                        <div className="mt-10 p-6 rounded-2xl bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800">
                            ...
                            <h4 className="text-xl font-bold text-gray-900 dark:text-blue-100 mb-3">
                                ¿Qué significa este expediente?
                            </h4>


                            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                Este expediente representa una propuesta presentada por un Ayuntamiento.
                                La propuesta será revisada por el Congreso antes de decidir si se aprueba,
                                modifica o rechaza.
                            </p>
                        ...
                        <div className="mt-10 border-t border-gray-200 dark:border-gray-700 pt-8 flex justify-center">
                            <div className="relative overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-800 shadow-md group w-full max-w-xl">
                                <img
                                src="https://congreso-gto.s3.amazonaws.com/uploads/comunicado/imagen/11635/inicio_WhatsApp_Image_2026-06-04_at_11.44.16_AM.jpeg"
                                alt="Expediente legislativo"
            ...
            {/* ================= PROPUESTA ================= */}
            {seccionesActivas.includes("propuesta") && (
                <Card>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-4">
                                <img src="/PRI.png" className="w-24 h-24 object-contain" alt="Partido" />
                                <p className="font-semibold text-gray-800 dark:text-gray-200">PRI</p>
                            </div>
                            <div className="flex items-center gap-4">
                                <img src="/PAN.png" className="w-24 h-24 object-contain" alt="Partido" />
                                <p className="font-semibold text-gray-800 dark:text-gray-200">PAN</p>
                            </div>
                            <div className="flex items-center gap-4">
                                <img src="/PRD.png" className="w-24 h-24 object-contain" alt="Partido" />
                                <p className="font-semibold text-gray-800 dark:text-gray-200">PRD</p>
                            </div>
                            <div className="flex items-center gap-4">
                                <img src="/MOR.png" className="w-24 h-24 object-contain" alt="Partido" />
                                <p className="font-semibold text-gray-800 dark:text-gray-200">Morena</p>
                            </div>
                            <div className="flex items-center gap-4">
                                <img src="/MOV.png" className="w-24 h-24 object-contain" alt="Partido" />
                                <p className="font-semibold text-gray-800 dark:text-gray-200">Movimiento Ciudadano </p>
                            </div>
                        </div>
            ...
            {/* ================= SEGUIMIENTO ================= */}
            {seccionesActivas.includes("seguimiento") && (
            <Card>
            ...
            {/* ================= SESIONES ================= */}
            {seccionesActivas.includes("sesiones") && (
            <Card>
            ...
            {/* ================= DOCUMENTOS ================= */}
            {seccionesActivas.includes("documentos") && (
            <Card>
                ...
                <button className="px-5 py-3 rounded-xl bg-primary text-white font-semibold hover:bg-primary-dark transition-all shadow-sm">
            ...
            {/* ================= TECNICO ================= */}
            {seccionesActivas.includes("tecnico") && (
            <Card>
