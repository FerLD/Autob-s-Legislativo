        ...
        const dataProcesada: IniciativaCompleta = {
         ...dataAPI,
          ...
          descripcion_ciudadana: dataAPI.descripcion_ciudadana || 
            ...
            'Propuesta para mejorar una ley del estado de Guanajuato',
        ...
        <section className="container mx-auto px-4 py-16 max-w-6xl">
            ...
            <Card>
                ...
                <div className="p-5 rounded-xl bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800">
                    ...
                    <p className="font-semibold text-gray-800 dark:text-gray-200 mt-1">{data.fecha_entrega || 'Sin fecha'}</p>
                </div>
                <div className="p-5 rounded-xl bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800">
            ...
            <Card>
                ...
                <Info t="¿Para qué sirve esta propuesta?" d={data.objetivo || 'Busca mejorar cómo funciona el Congreso en este tema'} />
                ...
                <p className="text-gray-700 dark:text-gray-300 mt-2 leading-relaxed">{data.descripcion_ciudadana || data.resumen_corto}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-3">
                        {data.grupos_parlamentarios && data.grupos_parlamentarios.length > 0 ? (
                        ...
                        <p className="text-gray-400 text-sm">No se especificó grupo parlamentario</p>
                        )}
                    </div>
                    </div>
            ...
            <div id="documentos">
                <Card>
                    ...
                    <p className="mt-3 text-gray-600 dark:text-gray-400">Archivos oficiales del sistema SIAD listos para su consulta.</p>
                    ...
                    <div className="flex gap-3 mt-6">
                        ...
                        {documentos.some(contieneOFCIIL) && (
                    ...
                    {documentos.length === 0 ? (
                        ...
                        initial={{ opacity: 0 }} 
                        animate={{ opacity: 1 }}
                        className="p-8 rounded-2xl bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 text-center"
                        >
                        <FileText className="w-12 h-12 mx-auto text-gray-300 dark:text-gray-600 mb-3" />
                        <p className="text-gray-500 dark:text-gray-400">No hay documentos disponibles para esta iniciativa</p>
                        </motion.div>
                    ) : (
                        ...
                        return (
                            <motion.div
                            key={`doc-${index}-${doc.file?.substring(0, 20) || 'unknown'}`}
                            ...
                            <div className="flex items-start justify-between gap-4">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex items-center gap-2 flex-wrap mb-1">
                                        ...
                                        {esOFCIIL && (
                                        <span className="flex-shrink-0 text-xs bg-primary text-white px-2.5 py-1 rounded-full font-bold shadow-sm">
                                            OFCIIL
                                        </span>
                                        )}
                                    </div>
                                ...
                                <a
                                    ...
                                    className={`px-5 py-2.5 rounded-xl font-semibold transition-all shadow-sm hover:shadow-md whitespace-nowrap flex items-center gap-2 ${
                                    esOFCIIL 
                                ...
                                {doc.descripcion && (
                                    ...
                                    >
                                    {descripcionVisible === index? '↑ Ocultar' : '↓ Ver descripción'}
                                    </button>
                                )}
                                </div>
                            </div>
